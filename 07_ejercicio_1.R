...
# B) Guarda P0 y P1 en un Excel con dos hojas.
write.xlsx(p0, file = "Simulacion_Ratones/poblaciones.xlsx", sheetName = "p0")
write.xlsx(p1, file = "Simulacion_Ratones/poblaciones.xlsx", sheetName = "p1")

# C) Comprime todo en "Nueva_Generacion.zip".
