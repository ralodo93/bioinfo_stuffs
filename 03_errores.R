...
install.packages("openxlsx") # Instalar la librería (descargar la herramienta de internet)
...
##########################################################
# SECCIÓN: ¿QUÉ ESTÁ PASANDO AQUÍ? (Debug)
##########################################################
...
# Ejemplo 3
Temperatura_Muestra <- 38
if (temperatura_muestra > 37) {
  print("Alerta: Hipertermia"
} else
