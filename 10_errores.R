...
## Si aún así no sabes solucionar un error, acude a internet. Hasta hace unos años lo que se usaba era
## StackOverflow: que es una web de programación en varios lenguajes. Actualmente, para errores simples
## lo más sencillo es preguntar a una IA tipo ChatGPT. Es importante que si usáis una IA, le deis toda la información posible,
## ya que estas IAs no están demasiado optimizadas para código. Le pegáis el código que falla y le decis el error que sale
